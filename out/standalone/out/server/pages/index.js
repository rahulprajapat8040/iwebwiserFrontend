...
/* harmony import */ var _Utility_ApiUrl__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(3260);
...
const Home = next_dynamic__WEBPACK_IMPORTED_MODULE_2___default()(Promise.all(/* import() */[__webpack_require__.e(1664), __webpack_require__.e(3003)]).then(__webpack_require__.bind(__webpack_require__, 3003)), {
    loadableGenerated: {
        modules: [
...
const Footer = next_dynamic__WEBPACK_IMPORTED_MODULE_2___default()(Promise.all(/* import() */[__webpack_require__.e(1664), __webpack_require__.e(8138)]).then(__webpack_require__.bind(__webpack_require__, 8138)), {
    loadableGenerated: {
        modules: [
...
async function getStaticProps() {
    ...
    try {
        const [navRes, bannerRes, allserviceRes, AllCaseStudyRes, getAllCertificateRes, getAllOurClientRes, getAlltechnologyRes, getAllBlogRes, getAllFeedbackRes] = await Promise.all([
            ...
            (0,_hooks_useapi__WEBPACK_IMPORTED_MODULE_4__/* .callApi */ .t)(`${_Utility_ApiUrl__WEBPACK_IMPORTED_MODULE_5__/* .ApiUrl */ .l.getAllCertificate}`),
            (0,_hooks_useapi__WEBPACK_IMPORTED_MODULE_4__/* .callApi */ .t)(`${_Utility_ApiUrl__WEBPACK_IMPORTED_MODULE_5__/* .ApiUrl */ .l.getAllOurClient}`),
            (0,_hooks_useapi__WEBPACK_IMPORTED_MODULE_4__/* .callApi */ .t)(`${_Utility_ApiUrl__WEBPACK_IMPORTED_MODULE_5__/* .ApiUrl */ .l.getAlltechnology}`),
    ...
    const data = {
        ...
        OurServicesHomeSection: {
            ...
            serviceData: getAllServiceAPiData?.map((service)=>{
                const cleanDescription = service.short_description.replace(/<\/?[^>]+(>|$)/g, "");
                return {
                    title: service.title,
        ...
        ProjectSection: {
            ...
            InnerCard: getAllCaseStudyApiData?.map((caseStudy)=>({
        ...
        OurHomeTechSection: {
            ...
            TechSection: getAlltechnologyApiData?.map((tech)=>{
                return {
                    Img: tech.image,
                    language: tech.title
                };
        ...
        SolutionSection: {
            ...
            SolutionCarditem_1: getAllBlogApiData?.map((blog)=>({
                    Img: blog.image,
                    heading: blog.title,
    ...
    return {
        props: {
            sliderData: _Utility_HomeSliderData__WEBPACK_IMPORTED_MODULE_3__/* .sliderData */ .Z,
            data: {
                ...data,
                navData: navData || []
            }
