...
sgmail.setApiKey(
  "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"
);
  ...
  if (req.method === "POST") {
    ...
    try {
      const mailOptions = {
        ...
        html: generateEmailContent(data), //`<p> The OTP towards validating your email address is  ${token}</p>`,
      };
      ...
      return res
        .status(200)
        .json({ status: true, message: "Data send successfully" });
    } catch (err) {
      console.log(err);
