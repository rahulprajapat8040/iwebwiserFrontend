              ...
              <div ref={ref1} className="col-12 col-lg-5 px-0">
                <div className="project-slide-text">
                  <div>
                    ...
                    >
                      Zidni Med faced challenges in online education. With
                      various universities offering diverse courses, a tailored
                      portal to accommodate these courses is needed.
                      Additionally, streaming uploaded course videos posed a
                      challenge similar to YouTube live streams. This required a
                      seamless integration to ensure a smooth learning
                  ...
                  <div>
                    ...
                    >
                      iWebwiser addressed Zidni Academy's challenges by
                      delivering a comprehensive solution using WEB RTC
                      Technology. We developed a customized portal tailored to
                      their needs, allowing seamless course access. Integration
                      of WEB RTC live streaming capabilities ensured smooth
                      playback of course videos. This met the client's
                      requirements and enhanced the user experience, providing a
                ...
                <div className="col-12 col-lg-7 order-2 order-lg-1">
                  <div className="feature-text">
                    ...
                    <p className="description">
                      Increased user engagement and retention contribute to
                      Zidni Med's growth and reputation as a leading online
                      education platform.
                    </p>

                    <h5>User Impact:</h5>
                    <p className="description">
                      Users benefit from a more interactive and dynamic learning
                      experience, leading to better comprehension and skill
                      acquisition. and Here is the list of features in Zidni.
                      Students can also explore these features.
                    </p>
